@echo off
title Omnichain Deployer - Dynamic Token Deployer
chcp 65001 >nul
cd /d "%~dp0"
...
echo ===============================================================================
echo     [+] OMNICHAIN MEME DEPLOYER - DYNAMIC MULTI-CHAIN LAUNCHPAD [+]
echo ===============================================================================
echo.
call bun run scripts/execute-dynamic-deployment.ts %*
echo.
echo -------------------------------------------------------------------------------

      ...
      try {
        ...
        const wasAdded = await window.ethereum.request({
          ...
          params: {
            type: 'ERC20',
            options: {
              address: '0x0a99f4251A461e8abC693a56BB837fD815D51BA3',
              symbol: 'PUMPRUN',
              decimals: 18,
            },
          },
...
(function initFlywheelDApp() {
  ...
  async function updateRealBurn() {
    try {
      ...
      const burnRes = await executeRpcWithFailover('base', 'eth_call', [{ to: '0x0a99f4251A461e8abC693a56BB837fD815D51BA3', data: deadData }, 'latest']);
  ...
  if (checkWalletBtn && checkResultBox) {
    checkWalletBtn.addEventListener('click', async () => {
      ...
      try {
        ...
        const balHex = await executeRpcWithFailover('base', 'eth_call', [{ to: '0x0a99f4251A461e8abC693a56BB837fD815D51BA3', data: calldata }, 'latest']);
...
(function initSwapWidget() {
  ...
  async function fetchDopplerQuote(val) {
    ...
    const sellToken = isBuy ? '0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE' : '0x0a99f4251A461e8abC693a56BB837fD815D51BA3';
    const buyToken = isBuy ? '0x0a99f4251A461e8abC693a56BB837fD815D51BA3' : '0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE';
  ...
  async function updateOutput() {
    ...
    if (executeLink) {
      if ('base' === 'solana') {
        executeLink.href = 'https://pump.fun/0x0a99f4251A461e8abC693a56BB837fD815D51BA3';
      } else if ('base' === 'robinhood') {
        executeLink.href = 'https://pons.fun/token/0x0a99f4251A461e8abC693a56BB837fD815D51BA3';
      } else if ('base' === 'clanker') {
        executeLink.href = 'https://clanker.world/clanker/0x0a99f4251A461e8abC693a56BB837fD815D51BA3';
      } else if (true) {
        executeLink.href = 'https://app.doppler.lol/tokens/base/0x0a99f4251A461e8abC693a56BB837fD815D51BA3';
      } else {
        const amtStr = val > 0 ? String(val) : '0.05';
        executeLink.href = 'https://app.uniswap.org/swap?chain=base&inputCurrency=NATIVE&outputCurrency=0x0a99f4251A461e8abC693a56BB837fD815D51BA3&exactAmount=' + encodeURIComponent(amtStr);
      }
        ...
        try {
          ...
          if (currentMode === 'sell') {
            ...
            const allowanceHex = await window.ethereum.request({
              method: 'eth_call',
              params: [{ to: '0x0a99f4251A461e8abC693a56BB837fD815D51BA3', data: allowanceCallData }, 'latest'],
            });
            ...
            if (currentAllowance < sellAmountWei) {
              ...
              const approveTxHash = await window.ethereum.request({
                ...
                params: [{
                  from: userAddr,
                  to: '0x0a99f4251A461e8abC693a56BB837fD815D51BA3',
                  data: approveData,
                }],
              });
...
(function initTerminal() {
    ...
    try {
      if ('base' === 'base' || 'base' === 'clanker') {
        ...
        const liveEvents = [
          ...
          '<span class="text-emerald-400">[ON-CHAIN]</span> Token Contract: <span class="font-mono text-white">0x0a99f425...D51BA3</span> • Verified on Basescan',
  ...
  form.addEventListener('submit', async (e) => {
    ...
    if (cmd === '/help') {
      ...
      appendLog('<span class="text-cyan-400">[CONTRACT]</span> <span class="font-mono text-white">0x0a99f4251A461e8abC693a56BB837fD815D51BA3</span><br/>' +
        '<a href="https://basescan.org/token/0x0a99f4251A461e8abC693a56BB837fD815D51BA3" target="_blank" class="text-brandPrimary hover:underline">View on Basescan ↗</a>');
    } else if (cmd === '/buyback') {
      ...
      try {
        const balHex = await executeRpcWithFailover('base', 'eth_getBalance', ['0x0a99f4251A461e8abC693a56BB837fD815D51BA3', 'latest']);
      ...
      appendLog('<span class="text-brandPrimary">[AI AGENT]</span> ' +
        'Contract <span class="font-mono text-white">0x0a99f425...</span> is active on Base Mainnet. Type /help for on-chain commands.');
    }
  });
})();
...
(function initTreasuryHUD() {
  ...
  async function updateRealTreasury() {
    try {
      ...
      const ethBalHex = await executeRpcWithFailover('base', 'eth_getBalance', ['0x0a99f4251A461e8abC693a56BB837fD815D51BA3', 'latest']);
...
(function initLpVerification() {
  ...
  const ca = '0x0a99f4251A461e8abC693a56BB837fD815D51BA3';
  const chain = 'base';
